...
def multy_window(root, s_matrix, k1_value, k2_value, d_value, t_value):
    ...
    # print(' parametric Game value = t +1, d +2', game_value.evalf(subs={t: t_value + 1, d: d_value + 2}))
    # print(' parametric Game value = t +1, d +3', game_value.evalf(subs={t: t_value + 1, d: d_value + 3}))
    # print(' parametric Game value = t +1, d +4', game_value.evalf(subs={t: t_value + 1, d: d_value + 4}))
    # print(' parametric Game value = t +1, d +5', game_value.evalf(subs={t: t_value + 1, d: d_value + 5}))
    # print(' parametric Game value = t +2, d +2', game_value.evalf(subs={t: t_value + 2, d: d_value + 2}))
    # print(' parametric Game value = t +3, d +2', game_value.evalf(subs={t: t_value + 3, d: d_value + 2}))
    # print(' parametric Game value = t +4, d +2', game_value.evalf(subs={t: t_value + 4, d: d_value + 2}))
    # print(' parametric Game value = t +5, d +2', game_value.evalf(subs={t: t_value + 5, d: d_value + 2}))
    ...
    for k1 in range(0, len(x_probability)):
        ...
        if is_number(probability_values[k1]):
            ...
            # print(' x_probability = t +1, d +2', probability_values[k1].evalf(subs={t: t_value + 1, d: d_value + 2}))
            # print(' x_probability = t +1, d +3', probability_values[k1].evalf(subs={t: t_value + 1, d: d_value + 3}))
            # print(' x_probability = t +1, d +4', probability_values[k1].evalf(subs={t: t_value + 1, d: d_value + 4}))
            # print(' x_probability = t +1, d +5', probability_values[k1].evalf(subs={t: t_value + 1, d: d_value + 5}))
            # print(' x_probability = t +2, d +2', probability_values[k1].evalf(subs={t: t_value + 2, d: d_value + 2}))
            # print(' x_probability = t +3, d +2', probability_values[k1].evalf(subs={t: t_value + 3, d: d_value + 2}))
            # print(' x_probability = t +4, d +2', probability_values[k1].evalf(subs={t: t_value + 4, d: d_value + 2}))
            # print(' x_probability = t +5, d +2', probability_values[k1].evalf(subs={t: t_value + 5, d: d_value + 2}))

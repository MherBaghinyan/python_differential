...
# naver
# x_parametric_array = [0, (-4.13602670802749*d - 6.69275490563015e-8*t + (d - 0.5)**2*(2.95343527662159e-12*t - 7.38358819155397e-11) - 2.95342808487512e-13*(d - 0.5)**2*(t - 25)**2 + 8.27205676240782*(d - 0.5)**2 + (d - 0.5)*(-1.33854113631795e-7*t + 3.34635284079487e-6) + 8.03118774920441e-9*(d - 0.5)*(t - 25)**2 + 4.01564309856996e-9*(t - 25)**2 + 4.13603005440494)/(-30.7106781044619*d - 6.85369239248297e-7*t + (d - 0.5)**2*(-7.63414304535253e-13*t + 1.90853576133813e-11) + (d - 0.5)**2*(8.37794749763616e-13*t - 2.09448687440904e-11) + (d - 0.5)**2*(2.95343527662159e-12*t - 7.38358819155397e-11) + (d - 0.5)**2*(3.42259211421014e-12*t - 8.55648028552536e-11) - 6.45039702613079e-13*(d - 0.5)**2*(t - 25)**2 + 61.421390477332*(d - 0.5)**2 + (d - 0.5)*(-5.86762150315607e-7*t + 1.46690537578902e-5) + (d - 0.5)*(-4.01374700280664e-7*t + 1.00343675070166e-5) + (d - 0.5)*(-2.48745364128979e-7*t + 6.21863410322448e-6) + (d - 0.5)*(-1.33854113631795e-7*t + 3.34635284079487e-6) + 8.22440506932666e-8*(d - 0.5)*(t - 25)**2 + 4.11221328535021e-8*(t - 25)**2 + 30.7107123729239), 0, (-20.9713842362948*d - 2.93381214789896e-7*t + (d - 0.5)**2*(8.37794749763616e-13*t - 2.09448687440904e-11) - 8.37797340853945e-14*(d - 0.5)**2*(t - 25)**2 + 41.9427831416434*(d - 0.5)**2 + (d - 0.5)*(-5.86762150315607e-7*t + 1.46690537578902e-5) + 3.52057122630419e-8*(d - 0.5)*(t - 25)**2 + 1.7602870094752e-8*(t - 25)**2 + 20.9713989053555)/(-30.7106781044619*d - 6.85369239248297e-7*t + (d - 0.5)**2*(-7.63414304535253e-13*t + 1.90853576133813e-11) + (d - 0.5)**2*(8.37794749763616e-13*t - 2.09448687440904e-11) + (d - 0.5)**2*(2.95343527662159e-12*t - 7.38358819155397e-11) + (d - 0.5)**2*(3.42259211421014e-12*t - 8.55648028552536e-11) - 6.45039702613079e-13*(d - 0.5)**2*(t - 25)**2 + 61.421390477332*(d - 0.5)**2 + (d - 0.5)*(-5.86762150315607e-7*t + 1.46690537578902e-5) + (d - 0.5)*(-4.01374700280664e-7*t + 1.00343675070166e-5) + (d - 0.5)*(-2.48745364128979e-7*t + 6.21863410322448e-6) + (d - 0.5)*(-1.33854113631795e-7*t + 3.34635284079487e-6) + 8.22440506932666e-8*(d - 0.5)*(t - 25)**2 + 4.11221328535021e-8*(t - 25)**2 + 30.7107123729239), 0, 0, (-4.61297459700219*d - 2.00687920573667e-7*t + (d - 0.5)**2*(3.42259211421014e-12*t - 8.55648028552536e-11) - 3.42258399882404e-13*(d - 0.5)**2*(t - 25)**2 + 9.2259592283719*(d - 0.5)**2 + (d - 0.5)*(-4.01374700280664e-7*t + 1.00343675070166e-5) + 2.4082413564998e-8*(d - 0.5)*(t - 25)**2 + 1.20412638257531e-8*(t - 25)**2 + 4.61298463139822)/(-30.7106781044619*d - 6.85369239248297e-7*t + (d - 0.5)**2*(-7.63414304535253e-13*t + 1.90853576133813e-11) + (d - 0.5)**2*(8.37794749763616e-13*t - 2.09448687440904e-11) + (d - 0.5)**2*(2.95343527662159e-12*t - 7.38358819155397e-11) + (d - 0.5)**2*(3.42259211421014e-12*t - 8.55648028552536e-11) - 6.45039702613079e-13*(d - 0.5)**2*(t - 25)**2 + 61.421390477332*(d - 0.5)**2 + (d - 0.5)*(-5.86762150315607e-7*t + 1.46690537578902e-5) + (d - 0.5)*(-4.01374700280664e-7*t + 1.00343675070166e-5) + (d - 0.5)*(-2.48745364128979e-7*t + 6.21863410322448e-6) + (d - 0.5)*(-1.33854113631795e-7*t + 3.34635284079487e-6) + 8.22440506932666e-8*(d - 0.5)*(t - 25)**2 + 4.11221328535021e-8*(t - 25)**2 + 30.7107123729239), 0, 0, (-0.990292563137412*d - 1.24372554828432e-7*t + (d - 0.5)**2*(-7.63414304535253e-13*t + 1.90853576133813e-11) + 7.63412398422309e-14*(d - 0.5)**2*(t - 25)**2 + 1.98059134490893*(d - 0.5)**2 + (d - 0.5)*(-2.48745364128979e-7*t + 6.21863410322448e-6) + 1.49247371160224e-8*(d - 0.5)*(t - 25)**2 + 7.46235583442698e-9*(t - 25)**2 + 0.990298781765151)/(-30.7106781044619*d - 6.85369239248297e-7*t + (d - 0.5)**2*(-7.63414304535253e-13*t + 1.90853576133813e-11) + (d - 0.5)**2*(8.37794749763616e-13*t - 2.09448687440904e-11) + (d - 0.5)**2*(2.95343527662159e-12*t - 7.38358819155397e-11) + (d - 0.5)**2*(3.42259211421014e-12*t - 8.55648028552536e-11) - 6.45039702613079e-13*(d - 0.5)**2*(t - 25)**2 + 61.421390477332*(d - 0.5)**2 + (d - 0.5)*(-5.86762150315607e-7*t + 1.46690537578902e-5) + (d - 0.5)*(-4.01374700280664e-7*t + 1.00343675070166e-5) + (d - 0.5)*(-2.48745364128979e-7*t + 6.21863410322448e-6) + (d - 0.5)*(-1.33854113631795e-7*t + 3.34635284079487e-6) + 8.22440506932666e-8*(d - 0.5)*(t - 25)**2 + 4.11221328535021e-8*(t - 25)**2 + 30.7107123729239)]

d_bound = 2.5
t_bound = 100

bounds = [d_bound, t_bound]
optimal = multy_nonlinear_max(x_parametric_array, 10, 10)

solo_nonlinear_max(x_parametric_array, 10, optimal[0] - 1)
